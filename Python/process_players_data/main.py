...
# -*- coding: UTF-8 -*-
"""
Module to process players data.
...
DATA_FILE_LOCATION = os.path.join(DIR_PATH, 'data.csv')
...
def get_top_players(players, top_players):
    """
...
with open(DATA_FILE_LOCATION, 'r', newline='') as csvfile:
...
def q_4():
    return get_top_players(PLAYERS_WAGE, TOP_PLAYERS)


# **Q5.** Who are the 10 oldest players?
def q_5():
    return get_top_players(PLAYERS_AGE, TOP_PLAYERS)
